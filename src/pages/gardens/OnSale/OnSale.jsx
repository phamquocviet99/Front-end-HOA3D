...
import CardProductAdded from "../RegistrationProduct/Components/CardProductAdded";
            ...
            <form className="flex  justify-start md:justify-start md:mt-0 items-center">
              <div className="relative w-full md:w-2/3">
                <input
                  type="text"
                  id="simple-search"
                  className="bg-white border-y border-l border-gray-300 text-gray-900 text-sm rounded-l-full  block w-full pl-5 p-2.5 shadow-md"
