...
export default function ModalWaitingDelivery({ visible, onClose }) {
        ...
        <div className="pl-4 pr-4 pb-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="mb-0 text-base mt-2">Trạng thái : Chờ giao hàng</p>
              <p className="mb-0 text-base mt-2">Cửa hàng : Minh Lan Shop</p>
              <p className="mb-0 text-base mt-2">Chành xe : Thành Bưởi</p>
