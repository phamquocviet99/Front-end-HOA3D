...
export default function ModalWaitingShopPayment({ visible, onClose }) {
  ...
  return (
    ...
    >
      <div style={{minWidth:"400px"}} className=" bg-white rounded  overflow-y-scroll h-3/4 md:overflow-y-hidden md:h-auto">
        ...
        <div className="pl-4 pr-4 pb-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="mb-0 text-base mt-2">Trạng thái : Chờ cửa hàng thanh toán</p>
