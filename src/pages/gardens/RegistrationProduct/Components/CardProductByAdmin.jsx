...
export default function CardProductByAdmin() {
  ...
  return (
    <div
      onDoubleClick={() => setIsCheck(!isCheck)}
      className="w-full mx-auto mt-2 test-width rounded-lg shadow-md bg-white"
    >
      <img
      ...
      {isCheck ? (
        <button
          ...
          className=" shadow-md  w-full bg-blue-500 hover:bg-blue-600 text-white flex justify-center items-center  py-2 px-3 rounded-b-lg "
        >
        ...
        <button
          ...
          className={
            isHover
              ? "shadow-md  w-full bg-red-400 hover:bg-red-400 text-white flex justify-center items-center  py-2 px-3 rounded-b-lg  "
              : " shadow-md  w-full bg-green-600 hover:bg-green-700 text-white flex items-center justify-center  py-2 px-3 rounded-b-lg  "
          }
        >
          {isHover ? (
            <>
