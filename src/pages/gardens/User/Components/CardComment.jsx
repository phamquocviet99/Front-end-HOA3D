  ...
  return (
    <div className="mt-3 ">
      <div className="p-2 border flex justify-start items-center w-full rounded-lg shadow-md">
        ...
        />
        <div className="ml-3">
            <p className="mb-1 text-sm mr-2 ">Tên cửa hàng : Vạn Hạnh</p>
          <div className="flex items-center mb-1">
            <p className="mb-0 text-sm mr-2 ">Đánh giá : </p>
            <svg
              aria-hidden="true"
          ...
          <div>
            <p className="mb-0 text-sm ">
              Bình luận :{" "}
              <span>Giao hàng đúng chất lương, lần sau sẽ ủng hộ tiếp</span>
            </p>
          </div>
        </div>
      </div>
